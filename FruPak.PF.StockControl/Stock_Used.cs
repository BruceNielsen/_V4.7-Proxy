...
namespace PF.StockControl
{
    public partial class Stock_Used : Form
    {
        ...
        public Stock_Used(int int_C_User_id, bool bol_w_a)
        {
            InitializeComponent();
            //restrict access
        ...
        private void AddColumnsProgrammatically()
        {
            ...
            col4.HeaderText = "Date Used";
            col4.Name = "Date_Used";
            col4.ReadOnly = true;

            col5.HeaderText = "Quanity";
            col5.Name = "Quantity";
            col5.ReadOnly = true;

            col6.HeaderText = "Comment";
            col6.Name = "Comment";
            col6.ReadOnly = true;
            col6.Width = 200;
        ...
        private void populate_datagridview()
        {
            ...
            ds_Get_Info = PF.Data.AccessLayer.PF_Stock_Used.Get_Info_Translated();
            ...
            for (int i = 0; i < Convert.ToInt32(ds_Get_Info.Tables[0].Rows.Count.ToString()); i++)
            {
                ...
                DGVC_User_Id.Value = dr_Get_Info["Stock_Used_Id"].ToString();
                ...
                DGVC_Cell5.Value = dr_Get_Info["Date_Used"].ToString();
                dataGridView1.Rows[i].Cells["Date_Used"] = DGVC_Cell5;
        ...
        private void btn_Add_Click(object sender, EventArgs e)
        {
            ...
            if (txt_comment.TextLength == 0)
            {
                str_msg = str_msg + "Invalid Comment. Please enter reason for the update." + Environment.NewLine;
            }

            if (str_msg.Length > 0)
            {
                DLR_MessageBox = MessageBox.Show(str_msg, "Process Factory - Consumable(Used)", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
            ...
            if (DLR_MessageBox != DialogResult.OK)
            {
                ...
                {
                    case "&Add":
                        int_result = PF.Data.AccessLayer.PF_Stock_Used.Insert(PF.Common.Code.General.int_max_user_id("PF_Stock_Used"), Convert.ToInt32(cmb_stock_Item.SelectedValue.ToString()), PF.Common.Code.General.Get_Season(),
                    ...
                    case "&Update":
                        int_result = PF.Data.AccessLayer.PF_Stock_Used.Update(int_DVG_Row_id, Convert.ToInt32(cmb_stock_Item.SelectedValue.ToString()),
                                        dtp_Arrival_Date.Value.Year.ToString() + "/" + dtp_Arrival_Date.Value.Month.ToString() + "/" + dtp_Arrival_Date.Value.Day.ToString(), Convert.ToInt32(nud_quantity.Value), txt_comment.Text, int_Current_User_Id);
            ...
            {
                lbl_message.Text = "Consumable Used failed to be added/Updated.";
        ...
        /// <param name="e"></param>
        private void Stock_Used_KeyDown(object sender, KeyEventArgs e)
        {
