...
using Reversible.Extensions.NonGeneric;
using System;
...
//using Tools;    // After a full rebuild and clean, this line got deleted, causing the collapsible splitter to fail
using Tools;    // After a full rebuild and clean, this line got deleted, causing the collapsible splitter to fail

#endregion Imports (22)
...
namespace FruPak.PF.Menu
{
    ...
    public partial class Main_Menu : Form
    {
        ...
        public Main_Menu()
        {
            ...
            this.selectPrinterToolStripMenuItem1.Text = Settings.Printer_Name;
        ...
        #region Methods of Main_Menu (355)
        ...
        private void chemicalsToolStripMenuItem1_Click(object sender, EventArgs e)
        {
        ...
        private void cleaningToolStripMenuItem1_Click(object sender, EventArgs e)
        {
        ...
        private void eSPToolStripMenuItem1_Click(object sender, EventArgs e)
        {
        ...
        void frm_HistoryUpdated(object sender, Accounts.HistoryUpdateEventArgs e)
        {
        ...
        private void growerToolStripMenuItem1_Click(object sender, EventArgs e)
        {
        ...
        void imn_NewTextChanged(object sender, TextEventArgs e)
        {
        ...
        void iwo_GP_Changed(object sender, GeneralPurposeObjectEventArgs e)
        {
        ...
        private void Main_Menu_Shown(object sender, EventArgs e)
        {
            ...
            this.Text += " v4.5 (20/05/2015)"; // Ribbon is now completely removed. 
            // Changed version number to match .Net framework version
        ...
        private void palletsToolStripMenuItem1_Click(object sender, EventArgs e)
        {
        ...
        //{
        //    // Special Case
        //    //rbcmb_Report_DropDownItemClicked
        //    //(this, EventArgs.Empty);
        ...
        //private void reportListToolStripMenuItem_Click_1(object sender, EventArgs e)
        //{
        //    // Special Case
        //    //this.rbcmb_Report_DropDownItemClicked
        //    //(this, EventArgs.Empty);
        ...
        #region Disabled Ribbon Handler Code - Has been replaced with standard Microsoft Controls - BN 19-05-2015

        //private void ribbonButton_Accounting_Costs_Rates_Click(object sender, EventArgs e)
        //{
        //    //historyAdd("Accounting - Costs - Rates");
        //    //logger.Log(LogLevel.Info, DecorateString("Accounting - Costs", "ribbonButton_Accounting_Costs_Rates_Click", "(Rates)"));

        //    //Cursor = Cursors.WaitCursor;
        //    //Form frm = new FruPak.PF.Accounts.Accounts_Maintenance("PF_A_Rates", int_User_id, Convert.ToBoolean((sender as RibbonButton).Tag.ToString()));
        //    //frm.Show();
        //    //Cursor = Cursors.Default;
        //}

        //private void ribbonButton_Accounting_Invoicing_FruitPurchase_Click(object sender, EventArgs e)
        //{
        //    //historyAdd("Accounting - Invoicing - Fruit Purchase");
        //    //logger.Log(LogLevel.Info, DecorateString("Accounting - Invoicing", "ribbonButton_Accounting_Invoicing_FruitPurchase_Click", "(Fruit Purchase)"));

        //    //Cursor = Cursors.WaitCursor;
        //    //Form frm = new FruPak.PF.Accounts.Fruit_Purchase(int_User_id, Convert.ToBoolean((sender as RibbonButton).Tag.ToString()));
        //    //frm.Show();
        //    //Cursor = Cursors.Default;
        //}

        //private void ribbonButton_Accounting_Invoicing_Intent_Order_Click(object sender, EventArgs e)
        //{
        //    //historyAdd("Accounting - Intent - Order");
        //    //logger.Log(LogLevel.Info, DecorateString("Accounting - Intent", "ribbonButton_Accounting_Invoicing_Intent_Order_Click", "(Order)"));

        //    //Cursor = Cursors.WaitCursor;
        //    //Form frm = new FruPak.PF.Accounts.Intended_Orders(int_User_id, Convert.ToBoolean((sender as RibbonButton).Tag.ToString()));
        //    //frm.Show();
        //    //Cursor = Cursors.Default;
        //}

        //private void ribbonButton_Accounting_Invoicing_OrderInvoiceLink_Click(object sender, EventArgs e)
        //{
        //    //historyAdd("Accounting - Invoicing - Order/Invoice Link");
        //    //logger.Log(LogLevel.Info, DecorateString("Accounting - Invoicing", "ribbonButton_Accounting_Invoicing_OrderInvoiceLink_Click", "(Order/Invoice Link)"));

        //    //Cursor = Cursors.WaitCursor;
        //    //Form frm = new FruPak.PF.Accounts.Order_Invoice_Link(int_User_id, Convert.ToBoolean((sender as RibbonButton).Tag.ToString()));
        //    //frm.Show();
        //    //Cursor = Cursors.Default;
        //}

        //private void ribbonButton_Accounting_Invoicing_PaymentReceived_Click(object sender, EventArgs e)
        //{
        //    //historyAdd("Accounting - Invoicing - Payments Received");
        //    //logger.Log(LogLevel.Info, DecorateString("Accounting - Invoicing", "ribbonButton_Accounting_Invoicing_PaymentReceived_Click", "(Payments Recieved)"));

        //    //Cursor = Cursors.WaitCursor;
        //    //Form frm = new FruPak.PF.Accounts.Payment_Received(int_User_id, Convert.ToBoolean((sender as RibbonButton).Tag.ToString()));
        //    //frm.Show();
        //    //Cursor = Cursors.Default;
        //}

        //private void ribbonButton_Accounting_Invoicing_Sales_Click(object sender, EventArgs e)
        //{
        //    //historyAdd("Accounting - Invoicing - Sales");
        //    //logger.Log(LogLevel.Info, DecorateString("Accounting - Invoicing", "ribbonButton_Accounting_Invoicing_Sales_Click", "(Sales)"));

        //    //Cursor = Cursors.WaitCursor;

        //    //FruPak.PF.Accounts.Invoicing_Sales frm = new FruPak.PF.Accounts.Invoicing_Sales(int_User_id, Convert.ToBoolean((sender as RibbonButton).Tag.ToString()));
        //    ////Form frm = new FruPak.PF.Accounts.Invoicing_Sales(int_User_id, Convert.ToBoolean((sender as RibbonButton).Tag.ToString()));
        ...
        //private void ribbonButton_Accounting_Invoicing_Search_Click(object sender, EventArgs e)
        //{
        //    //historyAdd("Accounting - Invoicing - Search");
        //    //logger.Log(LogLevel.Info, DecorateString("Accounting - Invoicing", "ribbonButton_Accounting_Invoicing_Search_Click", "(Search)"));
        ...
        //    //FruPak.PF.Accounts.Invoice_Search frm = new FruPak.PF.Accounts.Invoice_Search(int_User_id, Convert.ToBoolean((sender as RibbonButton).Tag.ToString()));
        ...
        //private void ribbonButton_Accounting_Invoicing_WorkOrder_Click(object sender, EventArgs e)
        //{
        //    //historyAdd("Accounting - Invoicing - Work Order");
        //    //logger.Log(LogLevel.Info, DecorateString("Accounting - Invoicing", "ribbonButton_Accounting_Invoicing_WorkOrder_Click", "(Work Order)"));

        //    //Cursor = Cursors.WaitCursor;
        //    //Form frm = new FruPak.PF.Accounts.Invoicing_WO(int_User_id, Convert.ToBoolean((sender as RibbonButton).Tag.ToString()));
        //    //frm.Show();
        //    //Cursor = Cursors.Default;
        //}

        //private void ribbonButton_Accounting_Sales_Discounts_Click(object sender, EventArgs e)
        //{
        //    //historyAdd("Accounting - Sales - Discounts");
        //    //logger.Log(LogLevel.Info, DecorateString("Accounting - Sales", "ribbonButton_Accounting_Sales_Discounts_Click", "(Discounts)"));

        //    //Cursor = Cursors.WaitCursor;
        //    //Form frm = new FruPak.PF.Accounts.Sales_Rates("PF_A_Customer_Sales_Discount", int_User_id, Convert.ToBoolean((sender as RibbonButton).Tag.ToString()));
        //    //frm.Show();
        //    //Cursor = Cursors.Default;
        //}

        //private void ribbonButton_Accounting_Sales_Rates_Click(object sender, EventArgs e)
        //{
        //    //historyAdd("Accounting - Sales - Rates");
        //    //logger.Log(LogLevel.Info, DecorateString("Accounting - Sales", "ribbonButton_Accounting_Sales_Rates_Click", "(Rates)"));

        //    //Cursor = Cursors.WaitCursor;
        //    //Form frm = new FruPak.PF.Accounts.Sales_Rates("PF_A_Customer_Sales_Rates", int_User_id, Convert.ToBoolean((sender as RibbonButton).Tag.ToString()));
        //    //frm.Show();
        //    //Cursor = Cursors.Default;
        //}

        //private void ribbonButton_Common_ESP_ESP_Click(object sender, EventArgs e)
        //{
        //    //historyAdd("Common - ESP - ESP");
        //    //logger.Log(LogLevel.Info, DecorateString("Common - ESP", "ribbonButton_Common_ESP_ESP_Click", "(ESP)"));

        //    //Cursor = Cursors.WaitCursor;
        //    //Form frm = new FruPak.PF.Utils.Common.Common_Maintenance("CM_ESP", int_User_id, Convert.ToBoolean((sender as RibbonButton).Tag.ToString()));
        //    //frm.Show();
        //    //Cursor = Cursors.Default;
        //}

        //private void ribbonButton_Common_Fruit_Type_Click(object sender, EventArgs e)
        //{
        //    //historyAdd("Common - Fruit - Type");
        //    //logger.Log(LogLevel.Info, DecorateString("Common - Fruit", "ribbonButton_Common_Fruit_Type_Click", "(Type)"));

        //    //Cursor = Cursors.WaitCursor;
        //    //Form frm = new FruPak.PF.Utils.Common.Common_Maintenance("CM_Fruit_Type", int_User_id, Convert.ToBoolean((sender as RibbonButton).Tag.ToString()));
        //    //frm.Show();
        //    //Cursor = Cursors.Default;
        //}

        //private void ribbonButton_Common_Fruit_Variety_Click(object sender, EventArgs e)
        //{
        //    //historyAdd("Common - Fruit - Variety");
        //    //logger.Log(LogLevel.Info, DecorateString("Common - Fruit", "ribbonButton_Common_Fruit_Variety_Click", "(Variety)"));

        //    //Cursor = Cursors.WaitCursor;
        //    //Form frm = new FruPak.PF.Utils.Common.Fruit_Variety(int_User_id, Convert.ToBoolean((sender as RibbonButton).Tag.ToString()));
        //    //frm.Show();
        //    //Cursor = Cursors.Default;
        //}

        //private void ribbonButton_Common_Groups_ProductGroups_Click(object sender, EventArgs e)
        //{
        //    //historyAdd("Common - Groups - Product Groups");
        //    //logger.Log(LogLevel.Info, DecorateString("Common - Groups", "ribbonButton_Common_Groups_ProductGroups_Click", "(Product Groups)"));

        //    //Cursor = Cursors.WaitCursor;
        //    //Form frm = new FruPak.PF.Utils.Common.Common_Maintenance("CM_Product_Group", int_User_id, Convert.ToBoolean((sender as RibbonButton).Tag.ToString()));
        //    //frm.Show();
        //    //Cursor = Cursors.Default;
        //}

        //private void ribbonButton_Common_Grower_Customer_Click(object sender, EventArgs e)
        //{
        //    //historyAdd("Common - Grower - Customer");
        //    //logger.Log(LogLevel.Info, DecorateString("Common - Grower", "ribbonButton_Common_Grower_Customer_Click", "(Customer)"));

        //    //Cursor = Cursors.WaitCursor;
        //    //Form frm = new FruPak.PF.Utils.Common.PF_Customer(int_User_id, Convert.ToBoolean((sender as RibbonButton).Tag.ToString()));
        //    //frm.Show();
        //    //Cursor = Cursors.Default;
        //}

        //private void ribbonButton_Common_Grower_Grower_Click(object sender, EventArgs e)
        //{
        //    //historyAdd("Common - Grower - Grower");
        //    //logger.Log(LogLevel.Info, DecorateString("Common - Grower", "ribbonButton_Common_Grower_Grower_Click", "(Grower)"));

        //    //Cursor = Cursors.WaitCursor;
        //    //Form frm = new FruPak.PF.Utils.Common.Grower(int_User_id, Convert.ToBoolean((sender as RibbonButton).Tag.ToString()));
        //    //frm.Show();
        //    //Cursor = Cursors.Default;
        //}

        //private void ribbonButton_Common_Grower_Orchardist_Click(object sender, EventArgs e)
        //{
        //    //historyAdd("Common - Grower - Orchardist");
        //    //logger.Log(LogLevel.Info, DecorateString("Common - Grower", "ribbonButton_Common_Grower_Orchardist_Click", "(Orchardist)"));

        //    //Cursor = Cursors.WaitCursor;
        //    //Form frm = new FruPak.PF.Utils.Common.Common_Maintenance2("CM_Orchardist", int_User_id, Convert.ToBoolean((sender as RibbonButton).Tag.ToString()));
        //    //frm.Show();
        //    //Cursor = Cursors.Default;
        //}

        //private void ribbonButton_Common_Grower_Trader_Click(object sender, EventArgs e)
        //{
        //    //historyAdd("Common - Grower - Trader");
        //    //logger.Log(LogLevel.Info, DecorateString("Common - Grower", "ribbonButton_Common_Grower_Trader_Click", "(Trader)"));

        //    //Cursor = Cursors.WaitCursor;
        //    //Form frm = new FruPak.PF.Utils.Common.Common_Maintenance2("CM_Trader", int_User_id, Convert.ToBoolean((sender as RibbonButton).Tag.ToString()));
        //    //frm.Show();
        //    //Cursor = Cursors.Default;
        //}

        //private void ribbonButton_Common_Location_OffSite_Cities_Click(object sender, EventArgs e)
        //{
        //    //historyAdd("Common - Location - OffSite - Cities");
        //    //logger.Log(LogLevel.Info, DecorateString("Common - Location - Offsite", "ribbonButton_Common_Location_OffSite_Cities_Click", "(Cities)"));

        //    //Cursor = Cursors.WaitCursor;
        //    //Form frm = new FruPak.PF.Utils.Common.Common_Maintenance("CM_Cities", int_User_id, Convert.ToBoolean((sender as RibbonButton).OwnerPanel.Items[0].Tag.ToString()));
        //    //frm.Show();
        //    //Cursor = Cursors.Default;
        //}

        //private void ribbonButton_Common_Location_OffSite_Trucks_Click(object sender, EventArgs e)
        //{
        //    //historyAdd("Common - Location - OffSite - Trucks");
        //    //logger.Log(LogLevel.Info, DecorateString("Common - Location - Offsite", "ribbonButton_Common_Location_OffSite_Trucks_Click", "(Trucks)"));

        //    //Cursor = Cursors.WaitCursor;
        //    //Form frm = new FruPak.PF.Utils.Common.Common_Maintenance("CM_Truck", int_User_id, Convert.ToBoolean((sender as RibbonButton).OwnerPanel.Items[0].Tag.ToString()));
        //    //frm.Show();
        //    //Cursor = Cursors.Default;
        //}

        //private void ribbonButton_Common_Location_OnSite_Location_Click(object sender, EventArgs e)
        //{
        //    //historyAdd("Common - Location - OnSite - Location");
        //    //logger.Log(LogLevel.Info, DecorateString("Common - Location - Onsite", "ribbonButton_Common_Location_OnSite_Location_Click", "(Location)"));

        //    //Cursor = Cursors.WaitCursor;
        //    //Form frm = new FruPak.PF.Utils.Common.Common_Maintenance("CM_Location", int_User_id, Convert.ToBoolean((sender as RibbonButton).OwnerPanel.Items[0].Tag.ToString()));
        //    //frm.Show();
        //    //Cursor = Cursors.Default;
        //}

        //private void ribbonButton_Common_Material_Material_Click(object sender, EventArgs e)
        //{
        //    //historyAdd("Common - Material - Material");
        //    //logger.Log(LogLevel.Info, DecorateString("Common - Material", "ribbonButton_Common_Material_Material_Click", "(Material)"));

        //    //Cursor = Cursors.WaitCursor;
        //    //Form frm = new FruPak.PF.Utils.Common.Material(int_User_id, Convert.ToBoolean((sender as RibbonButton).OwnerPanel.Items[0].Tag.ToString()));
        //    //frm.Show();
        //    //Cursor = Cursors.Default;
        //}

        //private void ribbonButton_Common_Types_Material_Brand_Click(object sender, EventArgs e)
        //{
        //    //historyAdd("Common - Types - Material - Brand");
        //    //logger.Log(LogLevel.Info, DecorateString("Common - Types - Material", "ribbonButton_Common_Types_Material_Brand_Click", "(Brand)"));
        //    //Cursor = Cursors.WaitCursor;
        //    //Form frm = new FruPak.PF.Utils.Common.Common_Maintenance("CM_Brand", int_User_id, Convert.ToBoolean((sender as RibbonButton).OwnerPanel.Items[0].Tag.ToString()));
        //    //frm.Show();
        //    //Cursor = Cursors.Default;
        //}

        //private void ribbonButton_Common_Types_Material_Count_Click(object sender, EventArgs e)
        //{
        //    //historyAdd("Common - Types - Material - Count");
        //    //logger.Log(LogLevel.Info, DecorateString("Common - Types - Material", "Common_Types_Material_Count_Click", "(Count)"));

        //    //Cursor = Cursors.WaitCursor;
        //    //Form frm = new FruPak.PF.Utils.Common.Common_Maintenance("CM_Count", int_User_id, Convert.ToBoolean((sender as RibbonButton).OwnerPanel.Items[0].Tag.ToString()));
        //    //frm.Show();
        //    //Cursor = Cursors.Default;
        //}

        //private void ribbonButton_Common_Types_Material_Grade_Click(object sender, EventArgs e)
        //{
        //    //historyAdd("Common - Types - Material - Grade");
        //    //logger.Log(LogLevel.Info, DecorateString("Common - Types - Material", "ribbonButton_Common_Types_Material_Grade_Click", "(Grade)"));

        //    //Cursor = Cursors.WaitCursor;
        //    //Form frm = new FruPak.PF.Utils.Common.Common_Maintenance("CM_Grade", int_User_id, Convert.ToBoolean((sender as RibbonButton).OwnerPanel.Items[0].Tag.ToString()));
        //    //frm.Show();
        //    //Cursor = Cursors.Default;
        //}

        //private void ribbonButton_Common_Types_Material_GrowingMethod_Click(object sender, EventArgs e)
        //{
        //    //historyAdd("Common - Types - Material - Growing Method");
        //    //logger.Log(LogLevel.Info, DecorateString("Common - Types - Material", "ribbonButton_Common_Types_Material_GrowingMethod_Click", "(Growing Method)"));

        //    //Cursor = Cursors.WaitCursor;
        //    //Form frm = new FruPak.PF.Utils.Common.Common_Maintenance("CM_Growing_Method", int_User_id, Convert.ToBoolean((sender as RibbonButton).OwnerPanel.Items[0].Tag.ToString()));
        //    //frm.Show();
        //    //Cursor = Cursors.Default;
        //}

        //private void ribbonButton_Common_Types_Material_MarketAttribute_Click(object sender, EventArgs e)
        //{
        //    //historyAdd("Common - Types - Material - Market Attribute");
        //    //logger.Log(LogLevel.Info, DecorateString("Common - Types - Material", "ribbonButton_Common_Types_Material_MarketAttribute_Click", "(Market Attribute)"));

        //    //Cursor = Cursors.WaitCursor;
        //    //Form frm = new FruPak.PF.Utils.Common.Common_Maintenance("CM_Market_Attribute", int_User_id, Convert.ToBoolean((sender as RibbonButton).OwnerPanel.Items[0].Tag.ToString()));
        //    //frm.Show();
        //    //Cursor = Cursors.Default;
        //}

        //private void ribbonButton_Common_Types_Material_Size_Click(object sender, EventArgs e)
        //{
        //    //historyAdd("Common - Types - Material - Size");
        //    //logger.Log(LogLevel.Info, DecorateString("Common - Types - Material", "ribbonButton_Common_Types_Material_Size_Click", "(Size)"));

        //    //Cursor = Cursors.WaitCursor;
        //    //Form frm = new FruPak.PF.Utils.Common.Common_Maintenance("CM_Size", int_User_id, Convert.ToBoolean((sender as RibbonButton).OwnerPanel.Items[0].Tag.ToString()));
        //    //frm.Show();
        //    //Cursor = Cursors.Default;
        //}

        //private void ribbonButton_Common_Types_Material_Treatment_Click(object sender, EventArgs e)
        //{
        //    //historyAdd("Common - Types - Material - Treatment");
        //    //logger.Log(LogLevel.Info, DecorateString("Common - Types - Material", "ribbonButton_Common_Types_Material_Treatment_Click", "(Treatment)"));

        //    //Cursor = Cursors.WaitCursor;
        //    //Form frm = new FruPak.PF.Utils.Common.Common_Maintenance("CM_Treatment", int_User_id, Convert.ToBoolean((sender as RibbonButton).OwnerPanel.Items[0].Tag.ToString()));
        //    //frm.Show();
        //    //Cursor = Cursors.Default;
        //}

        //private void ribbonButton_Common_Types_Types_Defect_Click(object sender, EventArgs e)
        //{
        //    //historyAdd("Common - Types - Types - Defect");
        //    //logger.Log(LogLevel.Info, DecorateString("Common - Types - Types", "ribbonButton_Common_Types_Types_Defect_Click", "(Defect)"));

        //    //Cursor = Cursors.WaitCursor;
        //    //Form frm = new FruPak.PF.Utils.Common.Common_Maintenance("CM_Defect", int_User_id, Convert.ToBoolean((sender as RibbonButton).OwnerPanel.Items[0].Tag.ToString()));
        //    //frm.Show();
        //    //Cursor = Cursors.Default;
        //}

        //private void ribbonButton_Common_Types_Types_DefectClass_Click(object sender, EventArgs e)
        //{
        //    //historyAdd("Common - Types - Types - Defect Class");
        //    //logger.Log(LogLevel.Info, DecorateString("Common - Types - Types", "ribbonButton_Common_Types_Types_DefectClass_Click", "(Defect Class)"));

        //    //Cursor = Cursors.WaitCursor;
        //    //Form frm = new FruPak.PF.Utils.Common.Common_Maintenance("CM_Defect_Class", int_User_id, Convert.ToBoolean((sender as RibbonButton).OwnerPanel.Items[0].Tag.ToString()));
        //    //frm.Show();
        //    //Cursor = Cursors.Default;
        //}

        //private void ribbonButton_Common_Types_Types_PackTypes_Click(object sender, EventArgs e)
        //{
        //    //historyAdd("Common - Types - Types - Pack Types");
        //    //logger.Log(LogLevel.Info, DecorateString("Common - Types - Types", "ribbonButton_Common_Types_Types_PackTypes_Click", "(Pack Types)"));
        //    //Cursor = Cursors.WaitCursor;
        //    //Form frm = new FruPak.PF.Utils.Common.Common_Maintenance("CM_Pack_Type", int_User_id, Convert.ToBoolean((sender as RibbonButton).OwnerPanel.Items[0].Tag.ToString()));
        //    //frm.Show();
        //    //Cursor = Cursors.Default;
        //}

        //private void ribbonButton_Common_Types_Types_Pallets_Click(object sender, EventArgs e)
        //{
        //    //historyAdd("Common - Types - Types - Pallets");
        //    //logger.Log(LogLevel.Info, DecorateString("Common - Types - Types", "ribbonButton_Common_Types_Types_Pallets_Click", "(Pallets)"));

        //    //Cursor = Cursors.WaitCursor;
        //    //Form frm = new FruPak.PF.Utils.Common.Common_Maintenance("CM_Pallet_Type", int_User_id, Convert.ToBoolean((sender as RibbonButton).OwnerPanel.Items[0].Tag.ToString()));
        //    //frm.Show();
        //    //Cursor = Cursors.Default;
        //}

        //private void ribbonButton_Common_Types_Types_Storage_Click(object sender, EventArgs e)
        //{
        //    //historyAdd("Common - Types - Types - Storage");
        //    //logger.Log(LogLevel.Info, DecorateString("Common - Types - Types", "ribbonButton_Common_Types_Types_Storage_Click", "(Storage)"));

        //    //Cursor = Cursors.WaitCursor;
        //    //Form frm = new FruPak.PF.Utils.Common.Common_Maintenance("CM_Storage", int_User_id, Convert.ToBoolean((sender as RibbonButton).OwnerPanel.Items[0].Tag.ToString()));
        //    //frm.Show();
        //    //Cursor = Cursors.Default;
        //}

        //private void ribbonButton_Consumables_Maintenance_Holding_Click(object sender, EventArgs e)
        //{
        //    //historyAdd("Consumables - Maintenance - Holding");
        //    //logger.Log(LogLevel.Info, DecorateString("Consumables - Maintenance", "ribbonButton_Consumables_Maintenance_Holding_Click", "(Holding)"));

        //    //Cursor = Cursors.WaitCursor;
        //    //Form frm = new FruPak.PF.StockControl.Stock_Holding(int_User_id, Convert.ToBoolean((sender as RibbonButton).Tag.ToString()));
        //    //frm.Show();
        //    //Cursor = Cursors.Default;
        //}

        //private void ribbonButton_Consumables_Maintenance_Maintenance_Click(object sender, EventArgs e)
        //{
        //    //historyAdd("Consumables - Maintenance - Maintenance");
        //    //logger.Log(LogLevel.Info, DecorateString("Consumables - Maintenance", "ribbonButton_Consumables_Maintenance_Maintenance_Click", "(Maintenance)"));

        //    //Cursor = Cursors.WaitCursor;
        //    //Form frm = new FruPak.PF.StockControl.Stock_Control_Maintenance("PF_Stock_Item", int_User_id, Convert.ToBoolean((sender as RibbonButton).Tag.ToString()));
        //    //frm.Show();
        //    //Cursor = Cursors.Default;
        //}

        //private void ribbonButton_Consumables_Maintenance_UsageAdjustment_Click(object sender, EventArgs e)
        //{
        //    //historyAdd("Consumables - Maintenance - Usage Adjustment");
        //    //logger.Log(LogLevel.Info, DecorateString("Consumables - Maintenance", "ribbonButton_Consumables_Maintenance_UsageAdjustment_Click", "(Usage Adjustment)"));

        //    //Cursor = Cursors.WaitCursor;
        //    //Form frm = new FruPak.PF.StockControl.Stock_Used(int_User_id, Convert.ToBoolean((sender as RibbonButton).Tag.ToString()));
        //    //frm.Show();
        //    //Cursor = Cursors.Default;
        //}

        //private void ribbonButton_Dispatch_BaseLoad_AddNew_Click(object sender, EventArgs e)
        //{
        //    //historyAdd("Dispatch - BaseLoad - Add New");
        //    //logger.Log(LogLevel.Info, DecorateString("Dispatch - Baseload", "ribbonButton_Dispatch_BaseLoad_AddNew_Click", "(Add New)"));

        //    //Cursor = Cursors.WaitCursor;
        //    //Form frm = new FruPak.PF.BaseLoad.Base_Load_Maintenance(int_User_id, Convert.ToBoolean((sender as RibbonButton).Tag.ToString()));
        //    //frm.Show();
        //    //Cursor = Cursors.Default;
        //}

        //private void ribbonButton_Dispatch_BaseLoad_AddOutput_Click(object sender, EventArgs e)
        //{
        //    //historyAdd("Dispatch - BaseLoad - Add Output");
        //    //logger.Log(LogLevel.Info, DecorateString("Dispatch - Baseload", "ribbonButton_Dispatch_BaseLoad_AddOutput_Click", "(Add Output)"));

        //    //DialogResult DLR_Message = new DialogResult();

        //    //if (ribbonCombo_BaseLoad_BaseLoadList.SelectedValue == null)
        //    //{
        //    //    DLR_Message = MessageBox.Show("Invalid Baseload Selection, Please select a valid Baseload from the drop down list.", "Process Factory Dispatch (BaseLoad).", MessageBoxButtons.OK, MessageBoxIcon.Error);
        //    //}
        //    //if (DLR_Message != System.Windows.Forms.DialogResult.OK)
        //    //{
        //    //    Cursor = Cursors.WaitCursor;
        //    //    Form frm = new FruPak.PF.WorkOrder.WO_Output(Convert.ToInt32(ribbonCombo_BaseLoad_BaseLoadList.SelectedValue.ToString()), int_User_id, Convert.ToBoolean((sender as RibbonButton).Tag.ToString()));
        //    //    frm.Show();
        //    //    Cursor = Cursors.Default;
        //    //}
        //}

        //private void ribbonButton_Dispatch_BaseLoad_Complete_Click(object sender, EventArgs e)
        //{
        //    //historyAdd("Dispatch - BaseLoad - Complete");
        //    //logger.Log(LogLevel.Info, DecorateString("Dispatch - Baseload", "ribbonButton_Dispatch_BaseLoad_Complete_Click", "(Complete)"));

        //    //string str_msg = "";

        //    //int int_result = 0;
        //    //if (ribbonCombo_BaseLoad_BaseLoadList.SelectedItem == null)
        //    //{
        //    //    str_msg = "You Must Select a Baseload from the drop down list";
        //    //}
        //    //else
        //    //{
        //    //    if (ribbonCombo_BaseLoad_BaseLoadList.SelectedItem.Tag != null)
        //    //    {
        //    //        try
        //    //        {
        //    //            int_result = FruPak.PF.Data.AccessLayer.PF_Work_Order.Update_Completed(Convert.ToInt32(ribbonCombo_BaseLoad_BaseLoadList.SelectedValue.ToString()), int_User_id);
        //    //            int_result = FruPak.PF.Data.AccessLayer.PF_BaseLoad.Complete(Convert.ToInt32(ribbonCombo_BaseLoad_BaseLoadList.SelectedItem.Tag.ToString()), false, int_User_id);
        //    //            lbl_message.ForeColor = System.Drawing.Color.Blue;
        //    //            lbl_message.Text = "Baseload has been Completed";
        ...
        //    //    MessageBox.Show(str_msg, "Process Factory - Complete", MessageBoxButtons.OK, MessageBoxIcon.Error);
        //    //}
        //    //ribbonCombo_BaseLoad_BaseLoadList.TextBoxText = "";
        //    //populate_Baseload_Comboboxes();
        //}

        //private void ribbonButton_Dispatch_BaseLoad_Reset_Click(object sender, EventArgs e)
        //{
        //    //historyAdd("Dispatch - BaseLoad - Reset");
        //    //logger.Log(LogLevel.Info, DecorateString("Dispatch - Baseload", "ribbonButton_Dispatch_BaseLoad_Reset_Click", "(Reset)"));

        //    //ribbonCombo_BaseLoad_BaseLoadList.TextBoxText = "";
        //    //populate_Baseload_Comboboxes();
        //}

        //private void ribbonButton_Dispatch_BaseLoad_Run_Click(object sender, EventArgs e)
        //{
        //    //historyAdd("Dispatch - BaseLoad - Run");
        //    //logger.Log(LogLevel.Info, DecorateString("Dispatch - Baseload", "ribbonButton_Dispatch_BaseLoad_Run_Click", "(Run)"));
        ...
        //    //{
        //    //    Cursor = Cursors.WaitCursor;
        //    //    Form frm = new FruPak.PF.BaseLoad.BLWO_Labels(Convert.ToInt32(ribbonCombo_BaseLoad_BaseLoadList.SelectedValue.ToString()), int_User_id, Convert.ToBoolean((sender as RibbonButton).Tag.ToString()));
        //    //    frm.Show();
        //    //    Cursor = Cursors.Default;
        //    //}
        //}

        //private void ribbonButton_Dispatch_Orders_Create_Click(object sender, EventArgs e)
        //{
        //    //historyAdd("Dispatch - Orders - Create");
        //    //logger.Log(LogLevel.Info, DecorateString("Dispatch - Orders", "ribbonButton_Dispatch_Orders_Create_Click", "(Create)"));

        //    //Cursor = Cursors.WaitCursor;
        //    //Form frm = new FruPak.PF.Dispatch.Shipping_Order(int_User_id, Convert.ToBoolean((sender as RibbonButton).Tag.ToString()));
        //    //frm.Show();
        //    //Cursor = Cursors.Default;
        //}

        //private void ribbonButton_Dispatch_Orders_Search_Click(object sender, EventArgs e)
        //{
        //    //historyAdd("Dispatch - Orders - Search");
        //    //logger.Log(LogLevel.Info, DecorateString("Dispatch - Orders", "ribbonButton_Dispatch_Orders_Search_Click", "(Search)"));

        //    //Cursor = Cursors.WaitCursor;
        //    //Form frm = new FruPak.PF.Dispatch.Shipping_Search(int_User_id, Convert.ToBoolean((sender as RibbonButton).Tag.ToString()));
        //    //frm.Show();
        //    //Cursor = Cursors.Default;
        //}

        //private void ribbonButton_Dispatch_Other_OtherWork_Click(object sender, EventArgs e)
        //{
        //    //historyAdd("Dispatch - Other - Other Work");
        //    //logger.Log(LogLevel.Info, DecorateString("Dispatch - Other", "ribbonButton_Dispatch_Other_OtherWork_Click", "(Other Work)"));
        //    //Cursor = Cursors.WaitCursor;
        //    //Form frm = new FruPak.PF.Dispatch.Other_Work(int_User_id, Convert.ToBoolean((sender as RibbonButton).Tag.ToString()));
        //    //frm.Show();
        //    //Cursor = Cursors.Default;
        //}

        //private void ribbonButton_Dispatch_Packing_Pack_Click(object sender, EventArgs e)
        //{
        //    //historyAdd("Dispatch - Packing - Pack");
        //    //logger.Log(LogLevel.Info, DecorateString("Dispatch - Packing", "ribbonButton_Dispatch_Packing_Pack_Click", "(Pack)"));

        //    //Cursor = Cursors.WaitCursor;
        //    //Form frm = new FruPak.PF.Utils.Scanning.Repack(int_User_id, Convert.ToBoolean((sender as RibbonButton).Tag.ToString()));
        //    //frm.Show();
        //    //Cursor = Cursors.Default;
        //}

        //private void ribbonButton_Dispatch_Scanning_AddProductToOrder_Click(object sender, EventArgs e)
        //{
        //    //historyAdd("Dispatch - Scanning - Add Product to Order");
        //    //logger.Log(LogLevel.Info, DecorateString("Dispatch - Scanning", "ribbonButton_Dispatch_Scanning_AddProductToOrder_Click", "(Add Product to Order)"));

        //    //Cursor = Cursors.WaitCursor;
        //    //Form frm = new FruPak.PF.Utils.Scanning.Tipping_Onto_Order(int_User_id, Convert.ToBoolean((sender as RibbonButton).Tag.ToString()));
        //    //frm.Show();
        //    //Cursor = Cursors.Default;
        //}

        //private void ribbonButton_Dispatch_Scanning_PalletTransfer_Click(object sender, EventArgs e)
        //{
        //    //historyAdd("Dispatch - Scanning - Pallet Transfer");
        //    //logger.Log(LogLevel.Info, DecorateString("Dispatch - Scanning", "ribbonButton_Dispatch_Scanning_PalletTransfer_Click", "(Pallet Transfer)"));

        //    //Cursor = Cursors.WaitCursor;
        //    //Form frm = new FruPak.PF.Utils.Scanning.Pallet_Transfer(int_User_id, Convert.ToBoolean((sender as RibbonButton).Tag.ToString()));
        //    //frm.Show();
        //    //Cursor = Cursors.Default;
        //}

        //private void ribbonButton_Dispatch_Scanning_PrintPalletCard_Click(object sender, EventArgs e)
        //{
        //    //historyAdd("Dispatch - Scanning - Print Pallet Card");
        //    //logger.Log(LogLevel.Info, DecorateString("Dispatch - Scanning", "ribbonButton_Dispatch_Scanning_PrintPalletCard_Click", "(Print Pallet Card)"));
        ...
        //private void ribbonButton_Extra_GateHouse_Submission_Click(object sender, EventArgs e)
        //{
        //    //historyAdd("Extra - GateHouse - Submission");
        //    //logger.Log(LogLevel.Info, DecorateString("Extra - Gatehouse", "ribbonButton_Extra_GateHouse_Submission_Click", "(Submission)"));

        //    //Cursor = Cursors.WaitCursor;
        //    //Form frm = new FruPak.PF.Temp.Submission(int_User_id, Convert.ToBoolean((sender as RibbonButton).Tag.ToString()));
        //    //frm.Show();
        //    //Cursor = Cursors.Default;
        //}

        //private void ribbonButton_Extra_History_LoadOldStockNumbers_Click(object sender, EventArgs e)
        //{
        //    //historyAdd("Extra - History - Load Old Stock Numbers");
        //    //logger.Log(LogLevel.Info, DecorateString("Extra - History", "ribbonButton_Extra_History_LoadOldStockNumbers_Click", "(Load Old Stock Numbers)"));

        //    //Cursor = Cursors.WaitCursor;
        //    //Form frm = new FruPak.PF.Temp.Pre_System_Stock(int_User_id, Convert.ToBoolean((sender as RibbonButton).Tag.ToString()));
        //    //frm.Show();
        //    //Cursor = Cursors.Default;
        //}

        //private void ribbonButton_Extra_Scanning_PalletWeights_Click(object sender, EventArgs e)
        //{
        //    //historyAdd("Extra - Scanning - Pallet Weights");
        //    //logger.Log(LogLevel.Info, DecorateString("Extra - Scanning", "ribbonButton_Extra_Scanning_PalletWeights_Click", "(Pallet Weights)"));

        //    //Cursor = Cursors.WaitCursor;
        //    //Form frm = new FruPak.PF.Utils.Scanning.Pallet_Weight(int_User_id, Convert.ToBoolean((sender as RibbonButton).Tag.ToString()));
        //    //frm.Show();
        //    //Cursor = Cursors.Default;
        //}

        //private void ribbonButton_Extra_Scanning_ReprintPalletCard_Click(object sender, EventArgs e)
        //{
        //    //historyAdd("Extra - Scanning - Reprint Pallet Card");
        //    //logger.Log(LogLevel.Info, DecorateString("Extra - Scanning", "ribbonButton_Extra_Scanning_ReprintPalletCard_Click", "(Reprint P/Card)"));
        ...
        //private void ribbonButton_Extra_Scanning_TabletMenu_Click(object sender, EventArgs e)
        //{
        //    //historyAdd("Extra - Scanning - Tablet Menu");
        //    //logger.Log(LogLevel.Info, DecorateString("Extra - Scanning", "ribbonButton_Extra_Scanning_TabletMenu_Click", "(Tablet Menu)"));
        ...
        //private void ribbonButton_Home_Help_Help_Click(object sender, EventArgs e)
        //{
        //    //if (System.IO.File.Exists("C:\\FruPak\\Documentation\\Help\\Process Factory.chm"))
        //    //{
        //    //    Help.ShowHelp(this, "file://C:\\FruPak\\Documentation\\Help\\Process Factory.chm");
        ...
        //private void ribbonButton_Home_Message_AddNew_Click(object sender, EventArgs e)
        //{
        //    historyAdd("Home - Message - Add New");
        //    logger.Log(LogLevel.Info, DecorateString("Home - Message", "ribbonButton_Home_Message_AddNew_Click", "(Add New)"));
        ...
        //private void ribbonButton_Maintenance_Cleaning_Area_Click(object sender, EventArgs e)
        //{
        //    //historyAdd("PF - Maintenance - Cleaning - Area");
        //    //logger.Log(LogLevel.Info, DecorateString("PF - Maintenance - Cleaning", "ribbonButton_Maintenance_Cleaning_Area_Click", "(Area)"));

        //    //Cursor = Cursors.WaitCursor;
        //    //Form frm = new FruPak.PF.WorkOrder.Work_Order_Maintenance("PF_Cleaning_Area", int_User_id, Convert.ToBoolean((sender as RibbonButton).OwnerPanel.Items[0].Tag.ToString()));
        //    //frm.Show();
        //    //Cursor = Cursors.Default;
        //}

        //private void ribbonButton_Maintenance_Cleaning_Parts_Click(object sender, EventArgs e)
        //{
        //    //historyAdd("PF - Maintenance - Cleaning - Parts");
        //    //logger.Log(LogLevel.Info, DecorateString("PF - Maintenance - Cleaning", "ribbonButton_Maintenance_Cleaning_Parts_Click", "(Parts)"));

        //    //Cursor = Cursors.WaitCursor;
        //    //Form frm = new FruPak.PF.WorkOrder.Work_Order_Maintenance("PF_Cleaning_Area_Parts", int_User_id, Convert.ToBoolean((sender as RibbonButton).OwnerPanel.Items[0].Tag.ToString()));
        //    //frm.Show();
        //    //Cursor = Cursors.Default;
        //}

        //private void ribbonButton_Maintenance_Lab_LabResults_Click(object sender, EventArgs e)
        //{
        //    //historyAdd("PF - Maintenance - Lab - Lab Results");
        //    //logger.Log(LogLevel.Info, DecorateString("PF - Maintenance - Lab", "ribbonButton_Maintenance_Lab_LabResults_Click", "(Lab Results)"));

        //    //Cursor = Cursors.WaitCursor;
        //    //Form frm = new FruPak.PF.WorkOrder.Work_Order_Maintenance("PF_Product_LabResults", int_User_id, Convert.ToBoolean((sender as RibbonButton).Tag.ToString()));
        //    //frm.Show();
        //    //Cursor = Cursors.Default;
        //}

        //private void ribbonButton_Maintenance_Staff_Maintenance_Click(object sender, EventArgs e)
        //{
        //    //historyAdd("PF - Maintenance - Staff - Maintenance");
        //    //logger.Log(LogLevel.Info, DecorateString("PF - Maintenance - Staff", "ribbonButton_Maintenance_Staff_Maintenance_Click", "(Maintenance)"));

        //    //Cursor = Cursors.WaitCursor;
        //    //Form frm = new FruPak.PF.Utils.Common.PF_Staff(int_User_id, Convert.ToBoolean((sender as RibbonButton).Tag.ToString()));
        //    //frm.Show();
        //    //Cursor = Cursors.Default;
        //}

        //private void ribbonButton_Maintenance_Staff_OtherWorkAreas_Click(object sender, EventArgs e)
        //{
        //    //historyAdd("PF - Maintenance - Staff - Other Work Areas");
        //    //logger.Log(LogLevel.Info, DecorateString("PF - Maintenance - Staff", "ribbonButton_Maintenance_Staff_OtherWorkAreas_Click", "(Other Work Areas)"));

        //    //Cursor = Cursors.WaitCursor;
        //    //Form frm = new FruPak.PF.Utils.Common.Common_Maintenance("PF_Other_Work_Types", int_User_id, Convert.ToBoolean((sender as RibbonButton).Tag.ToString()));
        //    //frm.Show();
        //    //Cursor = Cursors.Default;
        //}

        //private void ribbonButton_Maintenance_Types_Chemicals_Click(object sender, EventArgs e)
        //{
        //    //historyAdd("PF - Maintenance - Types - Chemicals");
        //    //logger.Log(LogLevel.Info, DecorateString("PF - Maintenance - Types", "ribbonButton_Maintenance_Types_Chemicals_Click", "(Chemicals)"));

        //    //Cursor = Cursors.WaitCursor;
        //    //Form frm = new FruPak.PF.WorkOrder.Work_Order_Maintenance("PF_Chemicals", int_User_id, Convert.ToBoolean((sender as RibbonButton).OwnerPanel.Items[0].Tag.ToString()));
        //    //frm.Show();
        //    //Cursor = Cursors.Default;
        //}

        //private void ribbonButton_Maintenance_Types_OtherValues_Click(object sender, EventArgs e)
        //{
        //    //historyAdd("PF - Maintenance - Types - Other Values");
        //    //logger.Log(LogLevel.Info, DecorateString("PF - Maintenance - Types", "ribbonButton_Maintenance_Types_OtherValues_Click", "(Other Values)"));

        //    //Cursor = Cursors.WaitCursor;
        //    //Form frm = new FruPak.PF.WorkOrder.Work_Order_Maintenance("PF_Product_Other", int_User_id, Convert.ToBoolean((sender as RibbonButton).OwnerPanel.Items[0].Tag.ToString()));
        //    //frm.Show();
        //    //Cursor = Cursors.Default;
        //}

        //private void ribbonButton_Maintenance_Types_Products_Click(object sender, EventArgs e)
        //{
        //    //historyAdd("PF - Maintenance - Types - Products");
        //    //logger.Log(LogLevel.Info, DecorateString("PF - Maintenance - Types", "ribbonButton_Maintenance_Types_Products_Click", "(Products)"));
        //    //Cursor = Cursors.WaitCursor;
        //    //Form frm = new FruPak.PF.WorkOrder.Work_Order_Maintenance("PF_Product", int_User_id, Convert.ToBoolean((sender as RibbonButton).OwnerPanel.Items[0].Tag.ToString()));
        //    //frm.Show();
        //    //Cursor = Cursors.Default;
        //}

        //private void ribbonButton_Maintenance_Types_Tests_Click(object sender, EventArgs e)
        //{
        //    //historyAdd("PF - Maintenance - Types - Tests");
        //    //logger.Log(LogLevel.Info, DecorateString("PF - Maintenance - Types", "ribbonButton_Maintenance_Types_Tests_Click", "(Tests)"));

        //    //Cursor = Cursors.WaitCursor;
        //    //Form frm = new FruPak.PF.WorkOrder.Work_Order_Maintenance("PF_Tests", int_User_id, Convert.ToBoolean((sender as RibbonButton).OwnerPanel.Items[0].Tag.ToString()));
        //    //frm.Show();
        //    //Cursor = Cursors.Default;
        //}

        //private void ribbonButton_ProcessFactory_Cleaning_Cleaning_Click(object sender, EventArgs e)
        //{
        //    //historyAdd("Process Factory - Cleaning - Cleaning");
        //    //logger.Log(LogLevel.Info, DecorateString("Process Factory - Cleaning", "ribbonButton_ProcessFactory_Cleaning_Cleaning_Click", "(Cleaning)"));

        //    //Cursor = Cursors.WaitCursor;
        //    //Form frm = new FruPak.PF.WorkOrder.Cleaning(int_User_id, Convert.ToBoolean((sender as RibbonButton).Tag.ToString()));
        //    //frm.Show();
        //    //Cursor = Cursors.Default;
        //}

        //private void ribbonButton_ProcessFactory_CompleteWorkOrders_Complete_Click(object sender, EventArgs e)
        //{
        //    //historyAdd("Process Factory - Complete Work Orders - Complete");
        //    //logger.Log(LogLevel.Info, DecorateString("Process Factory - Complete Work Orders", "ribbonButton_ProcessFactory_CompleteWorkOrders_Complete_Click", "(Complete)"));

        //    //Cursor = Cursors.WaitCursor;
        //    //Form frm = new FruPak.PF.WorkOrder.WO_Complete(int_User_id, Convert.ToBoolean((sender as RibbonButton).Tag.ToString()));
        //    //frm.Show();
        //    //Cursor = Cursors.Default;
        //}

        //private void ribbonButton_ProcessFactory_Setup_Factory_Click(object sender, EventArgs e)
        //{
        //    //historyAdd("Process Factory - Setup - Factory");
        //    //logger.Log(LogLevel.Info, DecorateString("Process Factory - Setup", "ribbonButton_ProcessFactory_Setup_Factory_Click", "(Factory)"));

        //    //Cursor = Cursors.WaitCursor;
        //    //Form frm = new FruPak.PF.WorkOrder.Process_Set_Up(int_User_id, Convert.ToBoolean((sender as RibbonButton).Tag.ToString()));
        //    //frm.Show();
        //    //Cursor = Cursors.Default;
        //}

        //private void ribbonButton_ProcessFactory_WorkOrders_Chemicals_Click(object sender, EventArgs e)
        //{
        //    //historyAdd("Process Factory - Work Orders - Chemicals");
        //    //logger.Log(LogLevel.Info, DecorateString("Process Factory - Work Orders", "ribbonButton_ProcessFactory_WorkOrders_Chemicals_Click", "(Chemicals)"));

        //    //DialogResult DLR_MessageBox = new DialogResult();
        //    //Cursor = Cursors.WaitCursor;
        //    //int int_WO_Id = 0;

        //    //if (ribbonCombo_ProcessFactory_WorkOrders_WorkOrder.SelectedValue != null && ribbonCombo_ProcessFactory_WorkOrders_WorkOrder.TextBoxText != "Work Order")
        //    //{
        //    //    int_WO_Id = Convert.ToInt32(ribbonCombo_ProcessFactory_WorkOrders_WorkOrder.SelectedValue.ToString());
        //    //}
        //    //if (int_WO_Id == 0 && int_current_WO_Id == 0)
        //    //{
        //    //    DLR_MessageBox = MessageBox.Show("Invalid Work Order - Please select a valid Work Order from the Drop Down List.", "FruPak - Menu", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        //    //if (DLR_MessageBox != DialogResult.OK)
        //    //{
        //    //    Form frm = new FruPak.PF.WorkOrder.WO_Chemicals(int_WO_Id, int_User_id, Convert.ToBoolean((sender as RibbonButton).Tag.ToString()));
        //    //    frm.Show();
        //    //}
        //    //Cursor = Cursors.Default;
        //}

        //private void ribbonButton_ProcessFactory_WorkOrders_CreateView_Click(object sender, EventArgs e)
        //{
        //    //historyAdd("Process Factory - Work Orders - Create/View");

        //    //logger.Log(LogLevel.Info, DecorateString("Process Factory - Work Orders", "ribbonButton_ProcessFactory_WorkOrders_CreateView_Click", "(Create / View)"));
        ...
        //    //    int_WO_Id = Convert.ToInt32(ribbonCombo_ProcessFactory_WorkOrders_WorkOrder.SelectedValue.ToString());
        //    //}
        //    //Form frm = new FruPak.PF.WorkOrder.WO_Create(int_WO_Id, int_User_id, Convert.ToBoolean((sender as RibbonButton).Tag.ToString()));
        //    //frm.ShowDialog();
        ...
        //private void ribbonButton_ProcessFactory_WorkOrders_DeleteWorkOrder_Click(object sender, EventArgs e)
        //{
        //    //historyAdd("Process Factory - Work Orders - Delete Work Order");
        //    //logger.Log(LogLevel.Info, DecorateString("Process Factory - Work Orders", "ribbonButton_ProcessFactory_WorkOrders_DeleteWorkOrder_Click", "(Delete Work Order)"));
        ...
        //    //    catch
        //    //    {
        //    //        lbl_message.Text = "Work Order " + int_WO_Id + " failed to deleted";
        //    //        lbl_message.ForeColor = System.Drawing.Color.Red;
        //    //    }
        //    //}
        //    //Cursor = Cursors.Default;
        ...
        //private void ribbonButton_ProcessFactory_WorkOrders_Output_Click(object sender, EventArgs e)
        //{
        //    //historyAdd("Process Factory - Work Orders - Output");
        //    //logger.Log(LogLevel.Info, DecorateString("Process Factory - Work Orders", "ribbonButton_ProcessFactory_WorkOrders_Output_Click", "(Output)"));
        ...
        //    //if (DLR_MessageBox != DialogResult.OK)
        //    //{
        //    //    Form frm = new FruPak.PF.WorkOrder.WO_Output(int_WO_Id, int_User_id, Convert.ToBoolean((sender as RibbonButton).Tag.ToString()));
        //    //    frm.Show();
        //    //}
        //    //Cursor = Cursors.Default;
        //}

        //private void ribbonButton_ProcessFactory_WorkOrders_Pallets_Click(object sender, EventArgs e)
        //{
        //    //historyAdd("Process Factory - Work Orders - Pallets");
        //    //logger.Log(LogLevel.Info, DecorateString("Process Factory - Work Orders", "ribbonButton_ProcessFactory_WorkOrders_Pallets_Click", "(Pallets)"));
        ...
        //    //if (DLR_MessageBox != DialogResult.OK)
        //    //{
        //    //    Form frm = new FruPak.PF.WorkOrder.WO_Labels(int_WO_Id, int_User_id, Convert.ToBoolean((sender as RibbonButton).Tag.ToString()));
        //    //    frm.Show();
        //    //}
        //    //Cursor = Cursors.Default;
        //}

        //private void ribbonButton_ProcessFactory_WorkOrders_QC_Click(object sender, EventArgs e)
        //{
        //    //historyAdd("Process Factory - Work Orders - QC");
        //    //logger.Log(LogLevel.Info, DecorateString("Process Factory - Work Orders", "ribbonButton_ProcessFactory_WorkOrders_QC_Click", "(QC)"));
        ...
        //    //if (DLR_MessageBox != DialogResult.OK)
        //    //{
        //    //    Form frm = new FruPak.PF.WorkOrder.QC(int_WO_Id, int_User_id, Convert.ToBoolean((sender as RibbonButton).Tag.ToString()));
        //    //    frm.Show();
        //    //}
        //    //Cursor = Cursors.Default;
        //}

        //private void ribbonButton_ProcessFactory_WorkOrders_Reset_Click(object sender, EventArgs e)
        //{
        //    //historyAdd("Process Factory - Work Orders - Reset");
        //    //logger.Log(LogLevel.Info, DecorateString("Process Factory - Work Orders", "ribbonButton_ProcessFactory_WorkOrders_Reset_Click", "(Reset)"));
        //    //Reset();
        //}

        //private void ribbonButton_ProcessFactory_WorkOrders_SetCurrent_Click(object sender, EventArgs e)
        //{
        //    //historyAdd("Process Factory - Work Orders - Set Current");
        //    //logger.Log(LogLevel.Info, DecorateString("Process Factory - Work Orders", "ribbonButton_ProcessFactory_WorkOrders_SetCurrent_Click", "(Set Current)"));
        ...
        //    //{
        //    //    lbl_message.ForeColor = System.Drawing.Color.Blue;
        //    //    lbl_message.Text = "Work Order: " + Convert.ToString(ribbonCombo_ProcessFactory_WorkOrders_WorkOrder.SelectedValue.ToString()) + " has set to Current";
        //    //    Reset();
        //    //}
        //    //Cursor = Cursors.Default;
        //}

        //private void ribbonButton_ProcessFactory_WorkOrders_Staff_Click(object sender, EventArgs e)
        //{
        //    //historyAdd("Process Factory - Work Orders - Staff");
        //    //logger.Log(LogLevel.Info, DecorateString("Process Factory - Work Orders", "ribbonButton_ProcessFactory_WorkOrders_Staff_Click", "(Staff)"));
        ...
        //    //if (DLR_MessageBox != DialogResult.OK)
        //    //{
        //    //    Form frm = new FruPak.PF.WorkOrder.WO_Staff(int_WO_Id, int_User_id, Convert.ToBoolean((sender as RibbonButton).Tag.ToString()));
        //    //    frm.Show();
        //    //}
        //    //Cursor = Cursors.Default;
        //}

        //private void ribbonButton_ProcessFactory_WorkOrders_Tests_Click(object sender, EventArgs e)
        //{
        //    //historyAdd("Process Factory - Work Orders - Tests");
        //    //logger.Log(LogLevel.Info, DecorateString("Process Factory - Work Orders", "ribbonButton_ProcessFactory_WorkOrders_Tests_Click", "(Tests)"));
        ...
        //    //if (DLR_MessageBox != DialogResult.OK)
        //    //{
        //    //    Form frm = new FruPak.PF.WorkOrder.WO_Tests(int_WO_Id, int_User_id, Convert.ToBoolean((sender as RibbonButton).Tag.ToString()));
        //    //    frm.Show();
        //    //}
        //    //Cursor = Cursors.Default;
        //}

        //private void ribbonButton_Reports_Maintenance_AddNewReport_Click(object sender, EventArgs e)
        //{
        //    //historyAdd("Reports - Maintenance - Add New Report");
        //    //logger.Log(LogLevel.Info, DecorateString("Reports - Maintenance", "ribbonButton_Reports_Maintenance_AddNewReport_Click", "(Add New Report)"));

        //    //Cursor = Cursors.WaitCursor;

        //    //// This litle addition is do determine the type of the sender
        //    //Type typ = sender.GetType();

        //    //if (typ == typeof(RibbonButton))
        //    //{
        //    //    Form frm = new FruPak.PF.WorkOrder.Work_Order_Maintenance("PF_Reports", int_User_id, Convert.ToBoolean((sender as RibbonButton).Tag.ToString()));
        //    //    frm.ShowDialog();
        ...
        //    //{
        //    //    // Can force this to work by disabling the security on the button, but it's a really bad idea, as the
        //    //    // security is buried all through the app. 
        //    //    // The tag is being set somehow at logon???
        //    //    // SOLVED!!! 12/05/2015 BN
        ...
        //private void ribbonButton_Reports_SSRS_Run_Click(object sender, EventArgs e)
        //{
        //    //historyAdd("Reports - SSRS - Run");
        //    //logger.Log(LogLevel.Info, DecorateString("Reports - SSRS", "ribbonButton_Reports_SSRS_Run_Click", "(Run)"));

        //    //if (ribbonCombo_Reports_SSRS_ReportList.SelectedItem == null)
        //    //{
        //    //    MessageBox.Show("You Must Select a Report from the drop down list", "Process Factory - Complete", MessageBoxButtons.OK, MessageBoxIcon.Error);
        //    //}
        //    //else
        //    //{
        //    //    Cursor = Cursors.WaitCursor;
        //    //    FruPak.PF.Common.Code.General.Report_Viewer(ribbonCombo_Reports_SSRS_ReportList.SelectedValue.ToString());
        //    //    Cursor = Cursors.Default;
        //    //}

        //}

        //private void ribbonButton_Security_Maintenance_Group_Click(object sender, EventArgs e)
        //{
        //    //historyAdd("Security - Maintenance - Group");
        //    //logger.Log(LogLevel.Info, DecorateString("Security - Maintenance", "ribbonButton_Security_Maintenance_Group_Click", "(Group)"));

        //    //Cursor = Cursors.WaitCursor;
        //    //Form frm_User = new FruPak.PF.Utils.Security.User_Group_Maintenance(int_User_id, Convert.ToBoolean((sender as RibbonButton).Tag.ToString()));
        //    //frm_User.Show();
        //    //Cursor = Cursors.Default;
        //}

        //private void ribbonButton_Security_Maintenance_User_Click(object sender, EventArgs e)
        //{
        //    //historyAdd("Security - Maintenance - User");
        //    //logger.Log(LogLevel.Info, DecorateString("Security - Maintenance", "ribbonButton_Security_Maintenance_User_Click", "(User)"));

        //    //Cursor = Cursors.WaitCursor;
        //    //Form frm_User = new FruPak.PF.Utils.Security.User_Maintenance(int_User_id, Convert.ToBoolean((sender as RibbonButton).Tag.ToString()));
        //    //frm_User.Show();
        //    //Cursor = Cursors.Default;
        //}

        //private void ribbonButton_Security_Menus_Panels_Click(object sender, EventArgs e)
        //{
        //    //historyAdd("Security - Menus - Panels");
        //    //logger.Log(LogLevel.Info, DecorateString("Security - Menus", "ribbonButton_Security_Menus_Panels_Click", "(Panels)"));

        //    //Cursor = Cursors.WaitCursor;
        //    //Form frm_User = new FruPak.PF.Utils.Security.Menu_Panel_Maintenance(int_User_id, Convert.ToBoolean((sender as RibbonButton).Tag.ToString()));
        //    //frm_User.Show();
        //    //Cursor = Cursors.Default;
        //}

        //private void ribbonButton_Security_Menus_Tabs_Click(object sender, EventArgs e)
        //{
        //    //historyAdd("Security - Menus - Tabs");
        //    //logger.Log(LogLevel.Info, DecorateString("Security - Menus", "ribbonButton_Security_Menus_Tabs_Click", "(Tabs)"));

        //    //Cursor = Cursors.WaitCursor;
        //    //Form frm_User = new FruPak.PF.Utils.Security.Menu_Maintenance(int_User_id, Convert.ToBoolean((sender as RibbonButton).Tag.ToString()));
        //    //frm_User.Show();
        //    //Cursor = Cursors.Default;
        //}

        //private void ribbonButton_Security_Server_Start_Click(object sender, EventArgs e)
        //{
        //    //historyAdd("Security - Server - Start");
        //    //logger.Log(LogLevel.Info, DecorateString("Security - Server", "ribbonButton_Security_Server_Start_Click", "(Start)"));

        //    //Cursor = Cursors.WaitCursor;
        //    //Form frm = new FruPak.PF.Utils.Server.Print_Server();
        //    //frm.Show();
        //    //Cursor = Cursors.Default;
        //}
        ...
        private void ribbonText_Common_Material_MaterialNumber_TextBoxValidated(object sender, EventArgs e)
        {
            //historyAdd("Common - Material Number: " + ribbonText_Common_Material_MaterialNumber.Text);
        }
        ...
        {
            // Will need try/catch handling to validate the combobox
            //rbbtn_R_S_Execute_Click(this.rbbtn_R_S_Execute, EventArgs.Empty);
        }

        private void runReportToolStripMenuItem_Click_1(object sender, EventArgs e)
        {
        ...
        private void salesRatesToolStripMenuItem1_Click(object sender, EventArgs e)
        {
        ...
        protected override void WndProc(ref Message m)
        {
            ...
            {
                MessageBox.Show("Bruce Was Here!!!");
            }
        ...
        #endregion Methods of Main_Menu (355)
    }
   /// <summary>
