...
namespace FruPak.PF.Accounts
{
    static class Program
    {
        ...
        static void Main()
        {
           ...
           // Application.Run(new SalesRates("PF_A_Customer_Sales_Discount",8, true));
           // Application.Run(new SalesRates("PF_A_Customer_Sales_Rates", 8, true));
           // Application.Run(new Invoicing_WO(8, true));
            Application.Run(new Invoicing_Sales(1, true));
           // Application.Run(new InvoiceSearch(1, true));
            //Application.Run(new Fruit_Purchase(8, true));
