...
namespace PF.Utils.Security
{
    ...
    */
    ...
    public partial class Menu_Maintenance : Form
    {
        ...
        public Menu_Maintenance(int int_C_User_Id, bool bol_w_a)
        {
        ...
        private void populate_datagridview()
        {
            ...
            DataSet ds_Get_Menu_Info = PF.Data.AccessLayer.SC_Menu.Get_Info();
            ...
            for (int i = 0; i < Convert.ToInt32(ds_Get_Menu_Info.Tables[0].Rows.Count.ToString()); i++)
            {
                ...
                DGVC_User_Id.Value = dr_Get_Menu_Info["Menu_Id"].ToString();
        ...
        private void btn_Add_Click(object sender, EventArgs e)
        {
            ...
            {
                DataSet ds_Get_Menu_Info = PF.Data.AccessLayer.SC_Menu.Get_Info(txt_Menu_Name.Text);
                if (Convert.ToInt32(ds_Get_Menu_Info.Tables[0].Rows.Count.ToString()) > 0)
                {
                    str_msg = str_msg + "Invalid Menu: A Menu by this name already exists. Please choose a different Group Name" + Environment.NewLine;
                }
            }
            ...
            if (str_msg.Length > 0)
            {
                DLR_MessageBox = MessageBox.Show(str_msg, "Security - Menu", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
            if (DLR_MessageBox != DialogResult.OK)
            {
                ...
                {
                    case "&Add":
                        int_result = PF.Data.AccessLayer.SC_Menu.Insert(PF.Common.Code.General.int_max_user_id("SC_Menu"), txt_Menu_Name.Text, txt_Menu_Description.Text, int_Current_User_Id);
                        break;

                    case "&Update":
                        int_result = PF.Data.AccessLayer.SC_Menu.Update(int_Menu_id, txt_Menu_Name.Text, txt_Menu_Description.Text, int_Current_User_Id);
                        break;
                }
            }
            ...
            if (int_result > 0)
            {
                ...
                lbl_message.Text = txt_Menu_Name.Text + " has been saved";
                Reset();
            }
            else
            {
                lbl_message.ForeColor = System.Drawing.Color.Red;
                lbl_message.Text = txt_Menu_Name.Text + " has NOT been saved";
            }
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (e.ColumnIndex == 5)
            {
                ...
                {
                    int_result = PF.Data.AccessLayer.SC_Menu_Group_Relationship.Delete(Convert.ToInt32(dataGridView1.Rows[e.RowIndex].Cells[0].Value.ToString()));
                    int_result = PF.Data.AccessLayer.SC_Menu.Delete(Convert.ToInt32(dataGridView1.Rows[e.RowIndex].Cells[0].Value.ToString()));
                }
        ...
        private void populate_check_boxList()
        {
            ...
            for (int i = 0; i < Convert.ToInt32(ds_Get_UserGroup_Info.Tables[0].Rows.Count.ToString()); i++)
            {
                ...
                checkedListBox1.Items.Add(dr_Get_UserGroup_Info["UserGroup_Id"].ToString() + " " + dr_Get_UserGroup_Info["Name"].ToString());
            }
        ...
        {
            DataSet ds_Get_Info = PF.Data.AccessLayer.SC_Menu_Group_Relationship.Get_Info(int_Menu_id);
            DataRow dr_Get_Info;
        ...
        {
            PF.Data.AccessLayer.SC_Menu_Group_Relationship.Delete(int_Menu_id);
            for (int i = 0; i < checkedListBox1.Items.Count; i++)
            {
                ...
                {
                    PF.Data.AccessLayer.SC_Menu_Group_Relationship.Insert(PF.Common.Code.General.int_max_user_id("SC_Menu_Group_Relationship"), int_UserGroup_id, int_Menu_id, int_Current_User_Id);
                }
                else
                {
                    PF.Data.AccessLayer.SC_Menu_Group_Relationship.Delete_UserGroup_From_Menu(int_UserGroup_id, int_Menu_id);
                }
            }
        }
        ...
        /// <param name="e"></param>
        private void Menu_Maintenance_KeyDown(object sender, KeyEventArgs e)
        {
