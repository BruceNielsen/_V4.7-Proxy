    ...
    */
    public partial class Menu_Maintenance : Form
    {
        ...
        private void populate_datagridview()
        {
            ...
            DataSet ds_Get_Menu_Info = FruPak.PF.Data.AccessLayer.SC_Menu.Get_Info();
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (e.ColumnIndex == 5)
            {
                ...
                {
                    int_result = FruPak.PF.Data.AccessLayer.SC_Menu_Group_Relationship.Delete(Convert.ToInt32(dataGridView1.Rows[e.RowIndex].Cells[0].Value.ToString()));
                    int_result = FruPak.PF.Data.AccessLayer.SC_Menu.Delete(Convert.ToInt32(dataGridView1.Rows[e.RowIndex].Cells[0].Value.ToString()));
                }
        ...
        {
            FruPak.PF.Data.AccessLayer.SC_Menu_Group_Relationship.Delete(int_Menu_id);
            for (int i = 0; i < checkedListBox1.Items.Count; i++)
            {
                ...
                {
                    FruPak.PF.Data.AccessLayer.SC_Menu_Group_Relationship.Insert(FruPak.PF.Common.Code.General.int_max_user_id("SC_Menu_Group_Relationship"), int_UserGroup_id, int_Menu_id, int_Current_User_Id);
                }
                else
                {
                    FruPak.PF.Data.AccessLayer.SC_Menu_Group_Relationship.Delete_UserGroup_From_Menu(int_UserGroup_id, int_Menu_id);
                }
            }
        }
