...
namespace FruPak.PF.WorkOrder
{
    public partial class WO_Chemicals : Form
    {
        ...
        public WO_Chemicals(int int_wo_Id, int int_C_User_id, bool bol_w_a)
        {
            InitializeComponent();
        ...
        private void AddColumnsProgrammatically()
        {
            ...
            col3.HeaderText = "Chemical_Id";
            col3.Name = "Chemical_Id";
            col3.ReadOnly = true;
            col3.Visible = false;

            col4.HeaderText = "Chemical";
            col4.Name = "Chemical";
            col4.ReadOnly = true;
        ...
        private void populate_datagrid()
        {
            ...
            for (int i = 0; i < Convert.ToInt32(ds_Get_Info.Tables[0].Rows.Count.ToString()); i++)
            {
                ...
                DGVC_Id.Value = dr_Get_Info["BatchChem_Id"].ToString();
                ...
                DGVC_Test_Passed.Value = dr_Get_Info["Chem_Passed"].ToString();
        ...
        private void Add_btn()
        {
            ...
            if (str_msg.Length != 0)
            {
                DLR_MessageBox = MessageBox.Show(str_msg, "Process Factory - Work Order(Chemical)", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
            ...
            if (int_result > 0)
            {
                ...
                lbl_message.Text = "Chemicals have been Added to the Work Order";
                Reset();
            }
            else
            {
                lbl_message.ForeColor = System.Drawing.Color.Red;
                lbl_message.Text = "Chemicals has NOT been saved to the Work Order";
            }
        }
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            else if (e.ColumnIndex == 8)
            {
                ...
                str_msg = str_msg + " Chemicals from Batch ";
                ...
                DLR_Message = MessageBox.Show(str_msg, "Process Factory - Chemical Deletion", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
        ...
        /// <param name="e"></param>
        private void WO_Chemicals_KeyDown(object sender, KeyEventArgs e)
        {
