...
namespace PF.BaseLoad
{
    ...
    public partial class BLWO_Labels : Form
    {
        ...
        private void btn_Add_Click(object sender, EventArgs e)
        {
            ...
            {
                int int_Season = PF.Common.Code.General.Get_Season();
                ...
                switch (btn_Add.Text)
                {
                    case "&Add":
                        ...
                        int_result = PF.Data.AccessLayer.PF_Pallet.Insert(int_Pallet_Id, Convert.ToInt32(cmb_Pallet_Type.SelectedValue.ToString()), str_barcode, Convert.ToInt32(cmb_Location.SelectedValue.ToString()), int_Trader_Id, Convert.ToBoolean(1), int_Season, int_Current_User_Id);
            ...
            if (int_result >= 0)
            {
                ...
                dec_Nett_Weight = dec_Nett_Weight + PF.Common.Code.General.Calculate_Nett_Weight(Convert.ToInt32(cmb_Material.SelectedValue.ToString()), nud_Quantity1.Value);
                dec_Nett_Weight = dec_Nett_Weight + PF.Common.Code.General.Calculate_Nett_Weight(Convert.ToInt32(cmb_Material.SelectedValue.ToString()), nud_Quantity2.Value);
                dec_Nett_Weight = dec_Nett_Weight + PF.Common.Code.General.Calculate_Nett_Weight(Convert.ToInt32(cmb_Material.SelectedValue.ToString()), nud_Quantity3.Value);

                PF.Data.AccessLayer.PF_Pallet.Update_Gross_Weight(int_Pallet_Id, dec_Nett_Weight, int_Current_User_Id);
        ...
        private int Process_Pallet_Details(int int_Pallet_Id, decimal dec_quantity1)
        {
            ...
            if (cmb_Batch1.SelectedItem != null || cmb_Batch1.Text != "")
            {
                ...
                int_result = PF.Data.AccessLayer.PF_Pallet_Details.Insert(PF.Common.Code.General.int_max_user_id("PF_Pallet_Details"), int_Pallet_Id, Convert.ToInt32(str_batch),
        ...
        {
            DataSet ds = PF.Data.AccessLayer.PF_PreSystem_Pallet_Stock.Get_Info(Material_id);
            DataRow dr;
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                {
                    PF.Data.AccessLayer.PF_PreSystem_Pallet_Stock.Update(int_PrePalletStock_ID, dec_current_total, int_Current_User_Id);
                }
                else
                {
                    PF.Data.AccessLayer.PF_PreSystem_Pallet_Stock.Update(int_PrePalletStock_ID, 0, int_Current_User_Id);
                }
            }
        }
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (e.ColumnIndex == 8)
            {
                ...
                PF.PrintLayer.Pallet_Card.Print(dataGridView1.Rows[e.RowIndex].Cells["Barcode"].Value.ToString(), true, int_Current_User_Id);
                PF.Data.AccessLayer.PF_Pallet.Update_For_PCard(Convert.ToInt32(dataGridView1.Rows[e.RowIndex].Cells["Pallet_Id"].Value.ToString()), true, int_Current_User_Id);
                ...
                //lst_filenames.AddRange(System.IO.Directory.GetFiles(@"\\FP-SBS\PublicDocs\FP\Server\Temp", "*" + dataGridView1.Rows[e.RowIndex].Cells["Barcode"].Value.ToString() + "*", System.IO.SearchOption.TopDirectoryOnly));
